...
function TServerMethods1(connectionInfo)
{
  ...
  /*
   * @param valorReal [in] - Type on server: string
   * @return result - Type on server: string
   */
  this.ConverteRealDolar = function(valorReal) {
    var returnObject = this.executor.executeMethod('ConverteRealDolar', "GET", [valorReal], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.valorReal = valorReal;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  this.ConverteRealDolar_URL = function(valorReal) {
    return this.executor.getMethodURL("ConverteRealDolar", "GET", [valorReal], arguments[1])[0];
  };

  /*
   * @param valorDolar [in] - Type on server: string
   * @return result - Type on server: string
   */
  this.ConverteDolarReal = function(valorDolar) {
    var returnObject = this.executor.executeMethod('ConverteDolarReal', "GET", [valorDolar], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.valorDolar = valorDolar;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
  ...
  this.ConverteDolarReal_URL = function(valorDolar) {
    return this.executor.getMethodURL("ConverteDolarReal", "GET", [valorDolar], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["EchoString","ReverseString","ConverteRealDolar","ConverteDolarReal"]
};
